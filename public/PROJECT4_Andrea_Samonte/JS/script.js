document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateForm() {
        ...
        const errorElements = [nameError, emailError, phoneError, dateError, timeError,
                              descriptionError, sizeError, locationError];
        ...
        const formInputs = [nameInput, emailInput, phoneInput, dateInput, timeInput,
                           descriptionInput, sizeSelect, locationSelect];
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        const existingSubmissions = JSON.parse(localStorage.getItem('tattooFormSubmissions') || '[]');
        existingSubmissions.push(formData);
        localStorage.setItem('tattooFormSubmissions', JSON.stringify(existingSubmissions));
